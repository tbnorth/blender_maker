...
hole = {
    ('PyBoard', (0, 0, 0), 'pybside'): {'g': 'RC', 'lab': '(I) V+', 'off':(-2, 0.5, 0)},
    ('PyBoard', (0, 2, 0), 'pybside'): {'g': 'RC', 'lab': '(J) GND', 'off':(-2, 0.5, 0)},
    ('PyBoard', (0, 4, 0), 'pybside'): {'g': 'RC', 'lab': '(C) Y12', 'off':(-2, 0.5, 0)},
    ('PyBoard', (0, 6, 0), 'pybside'): {'g': 'RC', 'lab': '(L) Y10', 'off':(-2, 0.5, 0)},
    ('PyBoard', (0, 7, 0), 'pybside'): {'g': 'RC', 'lab': '(K) Y9', 'off':(-2, 0.5, 0)},
    ('PyBoard', (0, 14, 0), 'pybside'): {'g': 'RC', 'lab': '(H) X2', 'off': (-4, 0.5, 0)},
    ('PyBoard', (0, 15, 0), 'pybside'): {'g': 'RC', 'lab': '(G) X1', 'off': (-4, 0.5, 0)},
    ('PyBoard', (1, 0, 0), 'pybtop'): {'g': 'RC', 'lab': '(F) V+', 'off': (0.5, 2, 0),
                             'rot': (0, 0, -90)},
    ('PyBoard', (2, 0, 0), 'pybtop'): {'g': 'RC', 'lab': '(E) GND', 'off': (0.5, 2, 0),
                             'rot': (0, 0, -90)},
    ('PyBoard', (1, 15, 0), 'pybside'): {'lab': '(B) V+', 'off': (2, 0.5, 0),
                             },
    ('PyBoard', (1, 13, 0), 'pybside'): {'lab': '(A) GND', 'off': (2, 0.5, 0),
                             },
    ('PyBoard', (1, 11, 0), 'pybside'): {'lab': '(D) X12', 'off': (2, 0.5, 0),
                             },
    ...
    ('rad.adapt', (3, 0, 0)): {'rot': (0, 0, -90), 'lab': '(E) GND', 'off': (0.5, -3.5, 0)},
    ('rad.adapt', (5, 0, 0)): {'rot': (0, 0, -90), 'lab': '(F) +5V', 'off': (0.5, -3.5, 0)},
    ('rad.adapt', (6, 0, 0)): {'rot': (0, 0, -90), 'lab': '(G) RX', 'off': (0.5, -3.5, 0)},
    ('rad.adapt', (7, 0, 0)): {'rot': (0, 0, -90), 'lab': '(H) TX', 'off': (0.5, -3.5, 0)},
    ...
    ('Cond_controller', (0, 0, 0), 'o'): {'lab': '(C) Temp Out', 'off': (4, 0.5, 0)},
    ('Cond_controller', (0, 2, 0), 'o'): {'lab': '(D) Cond Out', 'off': (4, 0.5, 0)},
    ('Cond_controller', (0, 0, 0), 'p'): {'rot': (0, 0, -90), 'lab': '(A) GND', 'off': (0.5, -5, 0)},
    ('Cond_controller', (1, 0, 0), 'p'): {'rot': (0, 0, -90), 'lab': '(B) +5V', 'off': (0.5, -5, 0)},
